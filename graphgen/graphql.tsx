...
export type Morph =
   ...
   | TypeRegisterEmbedUploader
   | Typeloginembeduploader
   | VerifyTokenPayload
   | ReturnSignup
   | ReturnUserData
   | EmbedUploader
   ...
   | EmbedUploaderAggregatorSum
   | EmbedUploaderAggregatorAvg
   | EmbedUploaderAggregatorMin
   | EmbedUploaderAggregatorMax
   | EmbedUploaderGroupBy
   | EmbedUploaderConnectionId
   | EmbedUploaderConnectionCreated_At
   | EmbedUploaderConnectionUpdated_At
   | EmbedUploaderConnectionUserName
   | EmbedUploaderConnectionPassword
   | EmbedUploaderConnectionTokenVersion
   | EmbedUploaderConnectionVerify
   | CreateEmbedUploaderPayload
   | UpdateEmbedUploaderPayload
   | DeleteEmbedUploaderPayload
   | EmbedVideo
   | EmbedVideoConnection
   | EmbedVideoAggregator
   | EmbedVideoAggregatorSum
   | EmbedVideoAggregatorAvg
   | EmbedVideoAggregatorMin
   | EmbedVideoAggregatorMax
   | EmbedVideoGroupBy
   | EmbedVideoConnectionId
   | EmbedVideoConnectionCreated_At
   | EmbedVideoConnectionUpdated_At
   | EmbedVideoConnectionMovieName
   | EmbedVideoConnectionSeason
   | EmbedVideoConnectionEpisode
   | EmbedVideoConnectionEigaLink
   | EmbedVideoConnectionOriginalLink
   | EmbedVideoConnectionUploadStatus
   | EmbedVideoConnectionUploader
   | EmbedVideoConnectionFileSize
   | EmbedVideoConnectionPublished_At
   ...
   | GenresGroupBy
   | GenresConnectionId
   | GenresConnectionCreated_At
   | GenresConnectionUpdated_At
   | GenresConnectionName
   | GenresConnectionUuid
   ...
   | MoviesGroupBy
   | MoviesConnectionId
   | MoviesConnectionCreated_At
   | MoviesConnectionUpdated_At
   | MoviesConnectionName
   | MoviesConnectionBody
   | MoviesConnectionUuid
   | MoviesConnectionFreeServer1
   | MoviesConnectionPhoto_Url
   | MoviesConnectionFreeServer2
   | MoviesConnectionVipServer1
   | MoviesConnectionVipServer2
   | MoviesConnectionPremiumOnly
   | MoviesConnectionRecommend
   | MoviesConnectionTv_Sery
   | MoviesConnectionQuality
   | MoviesConnectionViews
   | MoviesConnectionRelease_Date
   | MoviesConnectionDuration
   | MoviesConnectionPublished_At
   | CreateMoviePayload
   | UpdateMoviePayload
   | DeleteMoviePayload
   | TvSeries
   ...
   | TvSeriesAggregator
   | TvSeriesGroupBy
   | TvSeriesConnectionId
   | TvSeriesConnectionCreated_At
   | TvSeriesConnectionUpdated_At
   | TvSeriesConnectionName
   | TvSeriesConnectionPublished_At
   | CreateTvSeryPayload
   | UpdateTvSeryPayload
   | DeleteTvSeryPayload
   | UserData
   | UserDataConnection
   | UserDataAggregator
   | UserDataAggregatorSum
   | UserDataAggregatorAvg
   | UserDataAggregatorMin
   | UserDataAggregatorMax
   | UserDataGroupBy
   | UserDataConnectionId
   | UserDataConnectionCreated_At
   | UserDataConnectionUpdated_At
   | UserDataConnectionUuid
   | UserDataConnectionVerify
   | UserDataConnectionExpire
   | UserDataConnectionTokenVersion
   | UserDataConnectionPublished_At
   | CreateUserDatumPayload
   | UpdateUserDatumPayload
   | DeleteUserDatumPayload
   | WatchHistory
   | WatchHistoryConnection
   | WatchHistoryAggregator
   | WatchHistoryAggregatorSum
   | WatchHistoryAggregatorAvg
   | WatchHistoryAggregatorMin
   | WatchHistoryAggregatorMax
   | WatchHistoryGroupBy
   | WatchHistoryConnectionId
   | WatchHistoryConnectionCreated_At
   | WatchHistoryConnectionUpdated_At
   | WatchHistoryConnectionMovieName
   | WatchHistoryConnectionEpisode
   | WatchHistoryConnectionSeason
   | WatchHistoryConnectionUser_Data
   | WatchHistoryConnectionMovie
   | WatchHistoryConnectionPublished_At
   | CreateWatchHistoryPayload
   | UpdateWatchHistoryPayload
   | DeleteWatchHistoryPayload
   | I18NLocale
   | UploadFile
   ...
   | UpdateUserPayload
   | DeleteUserPayload
   | ComponentTvSeriesEpisodes
   | ComponentTvSeriesSeason
...
export type GetMovieQuery = {
   ...
   getMovie?: Maybe<{
      __typename?: 'Movies'
      freeServer1?: Maybe<string>
      freeServer2?: Maybe<string>
      vipServer1?: Maybe<string>
      vipServer2?: Maybe<string>
      name: string
      release_date?: Maybe<number>
      body: string
      genres?: Maybe<
         Array<Maybe<{ __typename?: 'Genres'; name?: Maybe<string> }>>
      >
   }>
}
...
export type GetRelatedMoviesQuery = {
   __typename?: 'Query'
   movies?: Maybe<
      Array<
         Maybe<{
 ...
 * });
 */
export function useGetRelatedMoviesQuery(
   baseOptions?: Apollo.QueryHookOptions<
      GetRelatedMoviesQuery,
      GetRelatedMoviesQueryVariables
   >
) {
   const options = { ...defaultOptions, ...baseOptions }
   return Apollo.useQuery<
      GetRelatedMoviesQuery,
      GetRelatedMoviesQueryVariables
   >(GetRelatedMoviesDocument, options)
}
export function useGetRelatedMoviesLazyQuery(
   baseOptions?: Apollo.LazyQueryHookOptions<
      GetRelatedMoviesQuery,
      GetRelatedMoviesQueryVariables
   >
...
export type GetRelatedMoviesQueryHookResult = ReturnType<
   typeof useGetRelatedMoviesQuery
>
export type GetRelatedMoviesLazyQueryHookResult = ReturnType<
   typeof useGetRelatedMoviesLazyQuery
>
export type GetRelatedMoviesQueryResult = Apollo.QueryResult<
   GetRelatedMoviesQuery,
   GetRelatedMoviesQueryVariables
>
 ...
 * });
 */
export function useGetSeriesQuery(
   baseOptions: Apollo.QueryHookOptions<GetSeriesQuery, GetSeriesQueryVariables>
) {
   const options = { ...defaultOptions, ...baseOptions }
   return Apollo.useQuery<GetSeriesQuery, GetSeriesQueryVariables>(
      GetSeriesDocument,
      options
   )
}
export function useGetSeriesLazyQuery(
   ...
   const options = { ...defaultOptions, ...baseOptions }
   return Apollo.useLazyQuery<GetSeriesQuery, GetSeriesQueryVariables>(
      GetSeriesDocument,
      options
   )
}
export type GetSeriesQueryHookResult = ReturnType<typeof useGetSeriesQuery>
export type GetSeriesLazyQueryHookResult = ReturnType<
   typeof useGetSeriesLazyQuery
>
export type GetSeriesQueryResult = Apollo.QueryResult<
   GetSeriesQuery,
   GetSeriesQueryVariables
>
